...
\begin{enumerate}
  ...
  \begin{enumerate}
    \item if $\mathsf{did}$ is provided, resolves it to obtain the associated DID document $\mathsf{DD}$ and public key $pk$; otherwise, uses the blinded pseudonym $\mathsf{nym}_r$ as the session identifier;
